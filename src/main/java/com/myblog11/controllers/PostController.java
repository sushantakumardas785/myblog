...
import com.myblog11.config.AppConstants;
import com.myblog11.payloads.ApiResponse;
import com.myblog11.payloads.PostDto;
import com.myblog11.payloads.PostResponse;
import com.myblog11.services.FileService;
import com.myblog11.services.PostService;
...
public class PostController {
    ...
    public ResponseEntity<List<PostDto>> searchPostByTitle(@PathVariable("keywords") String keywords) {
        List<PostDto> searchResults = this.postService.searchPosts(keywords);
